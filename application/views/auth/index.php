...
<div class="ml-3">
<h5 class='m-3 pull-left'>Employee Details</h5>


<div id="infoMessage"><?php echo $message;?></div>
<p class="pull-right mt-3">
<a href="<?=base_url('salaries')?>" class="btn-info btn alert-danger btn-sm"><i class="fa fa-money"></i> SALARIES</a>
<a href="<?=base_url('auth/create_user')?>" class="btn-info btn alert-primary btn-sm"><i class="fa fa-plus"></i> NEW EMPLOYEE</a>
</p>
